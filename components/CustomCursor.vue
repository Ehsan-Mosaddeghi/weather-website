...
<template>
  <div
    v-if="inMain"
    class="absolute -translate-x-1/2 -translate-y-1/2 w-10 h-10 rounded-full duration-200 transition ease-linear bg-yellow-200 shadow-[0_0_100px_80px_rgb(255,235,160)]"
